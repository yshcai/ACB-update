...
taco=/share/home/nxy1hj2cys/hifi/t2t_of/4.Annotation/02_StructuralAnnotation/03.RNA_Seq-based/04.gffcompare/taco_merge/assembly.format.gtf
threads=48
...
maker=/share/home/nxy1hj2cys/hifi/t2t_of/4.Annotation/02_StructuralAnnotation/04.MAKER/Ofur2_masked.maker.output/Ofur.maker.only.renamed.fixed.gff3
work=/share/home/nxy1hj2cys/hifi/t2t_of/4.Annotation/02_StructuralAnnotation/05.PASA

##### activate conda environment #####
source /share/home/nxy1hj2cys/miniconda3/bin/activate evm

##### Running the Alignment Assembly Pipeline #####
# 1. cleaning the transcript sequences
mkdir 01.seqclean && cd 01.seqclean
$transdecoder/util/gtf_genome_to_cdna_fasta.pl $taco $genome > transcripts.fasta
...
sed -i "s#^DATABASE=<__DATABASE__>#DATABASE=$work/02.alignment_assembly/database.sqlite/blat.Ofur_mydb_pasa.sqlite#g" alignAssembly.config
...
sed -i "s#^DATABASE=<__DATABASE__>#DATABASE=$work/02.alignment_assembly/database.sqlite/blat.Ofur_mydb_pasa.sqlite#g" annotCompare.config
...
# round3
mkdir round3 && cd round3
# load annotations into the PASA database
$pasa/scripts/Load_Current_Gene_Annotations.dbi \
        -c $work/02.alignment_assembly/alignAssembly.config -g $genome \
        -P $work/03.update_annotation/round2/*.gff3
# annotation comparison
$pasa/Launch_PASA_pipeline.pl \
        -c $work/03.update_annotation/annotCompare.config -A \
        -g $genome \
